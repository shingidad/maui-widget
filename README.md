...
- KeyEvent 등록 방법
  ...
  - MayUHD / maui
    ...
    ```javascript
    $MayUHD.addEventListener("keydown", function (e) {
        const keyCode = e.keyCode;
    	console.log(keyCode);
    });
    $MayUHD.addEventListener("keyup", function (e) {
        const keyCode = e.keyCode;
        console.log(keyCode);
    });
    ```
...
- Methods
  - addEventListener(type:string, callback:fcuntion)
     ...
     *  Video Play 
     */
    $MayUHD.addEventListener('video.play', function () {
    });
    /**
     *  Video Error
     */
    $MayUHD.addEventListener('video.error', function () {
    });
    /**
     *  Video Eended / finish
     */
    $MayUHD.addEventListener('video.finish', function () {
    });
    ```
  ...
  - video
     ...
     * @param {string} url
     */
    $MayUHD.videoPlay('http://clips.vorwaerts-gmbh.de/VfE_html5.mp4');
    /**
     * Video Pause
     */
    $MayUHD.videoPause();
     ...
     */
    $MayUHD.videoGetCurrentTime(function (time) {
     ...
     */
    $MayUHD.videoSetCurrentTime(50);
    /**
     * Get Duration Video
     * @param {function} duration - time
     */
    $MayUHD.getDuration(function (duration) {
