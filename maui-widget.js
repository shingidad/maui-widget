...
var _coreJs = __webpack_require__(129);
                ...
                window.addEventListener('message', function (e) {
                    ...
                    if (typeof type === 'string') {
                        if (type === 'video.currentTime') {
                            if (!isNull(_this._cbVideoCurrentTime)) {
                                _this._cbVideoCurrentTime(e.data.currentTime);
                                _this._cbVideoCurrentTime = null;
                            }
                        } else if (type === 'video.duration') {
                            // video duration
                            if (!isNull(_this._cbVideoDuration)) {
                                _this._cbVideoDuration(e.data.duration);
                            }
                        } else if (type === 'device.info') {
                            //
                            if (_this.__callBackGetDeviceInfo) {
                                _this.__callBackGetDeviceInfo();
                            }
                        } else {
